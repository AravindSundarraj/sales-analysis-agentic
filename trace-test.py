...
from helper.helper import get_openai_api_key, get_phoenix_endpoint
...
print("Using Phoenix endpoint:", get_phoenix_endpoint()+"/v1/traces")
OpenAIInstrumentor().instrument(tracer_provider = tracer_provider)
tracer = tracer_provider.get_tracer(__name__)

#defining the tool , database tool
